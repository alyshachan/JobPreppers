    ...
    public class StreamService
    {
        ...
        public StreamService()
        {
            ...
            Client = new StreamClient(
                ...
                new StreamClientOptions { Location = StreamApiLocation.USEast, Timeout = 16000 }
            );
        ...
        public async Task<ChannelGetResponse> CreateDMChannelAsync(
        ...
        )
        {
            ...
            var channel = await ChatChannelClient.GetOrCreateAsync(
                "messaging",
                new ChannelGetRequest { Data = channelData }
            );
