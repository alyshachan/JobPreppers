...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://jobpreppers.co:5000", "http://jobpreppers.co:3000", "http://jobpreppers.co", "http://jobpreppers.co", "https://jobpreppers.co") // react url
              .AllowAnyHeader()
              .AllowAnyMethod()
              .AllowCredentials();
    });
...
// app.Urls.Add("http://jobpreppers.co:5000");
