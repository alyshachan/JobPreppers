  ...
  const handleSearch = () => {
    ...
    return(
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
             <DateCalendar className="calendar" value={selectedDate} onChange={(newValue) => setSelectDate(newValue)} />
      ...
      <Button className='cancel-button' variant='text'  onClick={handleClose}> Cancel </Button>
      <Button className='save-button' variant="contained" onClick={handleSearch}> Show Result </Button>
      </div>
      </Menu>
        </>
    )
