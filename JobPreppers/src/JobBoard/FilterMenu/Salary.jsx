...
export default function Salary(){
  ...
  const handleCancel = () => {
    setSliderValue(20); // Reset to default value
    handleClose();
  };

  const handleShowResult = () => {
    console.log(`Selected Salary: $${sliderValue}`);
    handleClose();
    return sliderValue
  };
    return (
      ...
      <Button className='cancel-button' variant='text' onClick={handleCancel} > Cancel </Button>
      <Button className='save-button' variant="contained" onClick={handleShowResult}> Show Result </Button>
      </div>
      </Menu>
