...
import amazonIcon from "../Jobs/Img/amazon-icon.png";
import ReadMoreDrawer from "../Jobs/ReadMoreComponent/ReadMoreDrawer";
import styles from "../Jobs/Jobs.module.css";
import "../JobPreppers.css";
const apiURL = process.env.REACT_APP_JP_API_URL;

function CompanyJobs({ setDrawerOpen, jobs }) {
