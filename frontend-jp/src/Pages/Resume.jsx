...
function Resume() {
    ...
    const uploadResume = async () => {
        ...
        try {
            const response = await fetch("http://jobpreppers.co:5000/api/Resume/PostFile", {
                method: "POST",
                body: formData,
            });
    ...
    const generateSuggestions = async () => {
        ...
        setLoading(true);
        try {
            const response = await fetch("http://jobpreppers.co:5000/api/Resume/generate-suggestions", {
                method: "POST",
                headers: {
